...
XXL_YAML_PATH = BASE_DIR + os.sep + "config" + os.sep + "funds_xxl_config.yaml"
...
XXL_JOB_SIT_USERNMAE = 'admin'
XXL_JOB_SIT_PASSWORD = 'xVT5dVhWo9y7K$Hm'
...
XXL_JOB_SIT_HOST_CORE_API = 'http://xxl-job-sit.zhonglishuke.com/xxl-job-admin/toLogin'
