...
@allure.title("天源花渠道-授信成功-天源花API全流程")
@allure.story("天源花渠道-金美信资方授信案例-天源花API全流程")
@allure.severity(allure.severity_level.CRITICAL)
def test_tyh_jmx_credit_success():
...
@allure.epic("天源花渠道-金美信资方-天源花API全流程")
@allure.feature("天源花渠道-借款模块-天源花API全流程")
@allure.title("天源花渠道-借款成功-天源花API全流程")
@allure.story("天源花渠道-金美信资方借款案例-天源花API全流程")
@allure.severity(allure.severity_level.CRITICAL)
...
@allure.epic("天源花渠道-金美信资方-天源花API全流程")
@allure.feature("天源花渠道-还款模块-天源花API全流程")
