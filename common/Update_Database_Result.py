...
class Update_Sql_Result(Mysql):
    ...
    # api授信绑卡前进行修改成需要的对应资方,更新zx_credit_applicant_info表
    ...
    # api授信绑卡前进行修改成需要的对应资方,更新zx_credit_applicant_result表
    ...
    # api授信绑卡前进行修改成需要的对应资方,更新zx_credit_user_info表
    ...
    # api授信绑卡前进行修改成需要的对应资方,更新zl_drms_judgements表
    ...
    # api授信绑卡前进行修改成需要的对应资方,更新zx_credit_info表
    ...
    # api操作还款前对zx_loan_plan_info放款日期与还款计划进行修改,根据loan_apply_no来模糊查询,根据对应期数来修改日期
...
if __name__ == '__main__':
    ...
    print(Update_Sql_Result().update_api_core_fr_api_order_info_d0("SLN4401604407"))
