...
class Select_Sql_Result(Mysql):
    ...
    def select_credit_apply_no_by_tyh(self, tyh_credit_apply_no, test_db="tyh", max_retries=5, wait_time=30):
    ...
    def select_user_id_by_tyh(self, tyh_credit_apply_no, test_db="api", max_retries=5, wait_time=30):
