...
class Core_zjly_test_function:
    ...
    # 支付中台绑卡申请
    def test_zfzt_bank_apply(self, ACCOUNT_NAME="储担保", TEL="18277986451", ID="120119197602179736",
                             CREDIT_ACCTNO="6217007766322709779"):
    ...
    # 支付中台绑卡确认
    def test_zfzt_bank_confirm(self, reqsn):
        reqsn = reqsn
        businessChannel = 101
        req_data = {
            "reqSn": reqsn,
    ...
    # 支付中台扣款申请
    def test_zfzt_withhold_apply(self):
        reqsn = get_zfpt_req_no()
        businessChannel = 101
    ...
    # 支付中台扣款查询
    def test_zfzt_withhold_query(self):
